...
public class BillController {
    ...
    public BillController(CreateOfferFacade facade, DisableOfferFacade facadeDelete, FindOfferFacade facadeFind, ListOfferFacade facadeList, ExceptionHandlingAspect exceptionHandlingAspect) {
