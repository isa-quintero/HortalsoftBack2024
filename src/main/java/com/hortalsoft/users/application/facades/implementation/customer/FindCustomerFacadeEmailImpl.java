...
import com.hortalsoft.users.application.facades.facade.customer.FindCustomerFacadeEmail;
...
@Service
@Transactional
public class FindCustomerFacadeEmailImpl implements FindCustomerFacadeEmail {
    ...
    private final FindCustomerEmailUseCase useCase;
    private static final Layer layer = Layer.APPLICATION;

    public FindCustomerFacadeEmailImpl(FindCustomerEmailUseCase useCase) {
